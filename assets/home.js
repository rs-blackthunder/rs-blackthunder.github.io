...
// "Welcome"
// );
var aText = document.getElementById("typedTitle").replace("<noscript>","").replace("</noscript>","").innerHTML.split("<br>");
...
// );
var aTextText = document.getElementById("typedTextContent").replace("<noscript>","").replace("</noscript>","").innerHTML.split("<br>");
